...
/*cordina todo el proceso para crear una tarea donde a cada atributo le asignamos su funcion para asignarle el dato al atributo
ademas,esta funcion es impura,lo que hace es crear una nueva tarea y asignarla a la lista de tareas
*/
...
//a no mutar evitamos los efectos colaterales
